...
export const TreeIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.428 15.428a2.143 2.143 0 01-2.143 2.143H6.714a2.143 2.143 0 01-2.143-2.143v-3.857a2.143 2.143 0 012.143-2.143h10.571a2.143 2.143 0 012.143 2.143v3.857z" />
    </svg>
);
...
export const ChatBubbleLeftRightIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a1.125 1.125 0 01-1.59 0l-3.72-3.72c-1.133-.093-1.98-1.057-1.98-2.193V10.608c0-.97.616-1.813 1.5-2.097m0 0A7.496 7.496 0 0012 7.5a7.496 7.496 0 00-6.75 4.968" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 6.375c-1.065.23-1.92.951-2.348 1.874A2.25 2.25 0 004.5 10.5v2.25a2.25 2.25 0 001.5 2.086c.43.252.92.398 1.423.479" />
    </svg>
);
...
export const GlobeAltIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c1.355 0 2.707-.157 4.018-.452M12 21c-1.355 0-2.707-.157-4.018-.452M3.27 14.25a9.03 9.03 0 010-4.5M20.73 14.25a9.03 9.03 0 000-4.5M12 3a9.004 9.004 0 00-4.018.452M12 3a9.004 9.004 0 014.018.452M12 3c1.355 0 2.707.157 4.018.452M12 3c-1.355 0-2.707-.157-4.018.452M4.5 8.25a9.03 9.03 0 011.536-2.618M19.5 8.25a9.03 9.03 0 00-1.536-2.618m-1.42 5.136a.75.75 0 011.06 0l3 3a.75.75 0 01-1.06 1.06l-3-3a.75.75 0 010-1.06z" />
    </svg>
);
